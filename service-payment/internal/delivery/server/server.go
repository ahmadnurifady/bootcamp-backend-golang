...
import (
	...
	"log"
	"net/http"
	"service-payment/internal/config"
	"service-payment/internal/usecase"
	"service-payment/internal/utils/kafka"
...
func (s *Server) setupKafka() error {
	...
	s.consumer, err = kafka.NewKafkaConsumer(brokers, s.cfg.KafkaGroupId, []string{"validate_payment_topic"}, s.msg)
	if err != nil {
