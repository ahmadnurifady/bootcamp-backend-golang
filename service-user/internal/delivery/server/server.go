...
import (
	...
	"log"
	"net/http"
	"service-user/internal/config"
	"service-user/internal/usecase"
	"service-user/internal/utils/kafka"
...
func (s *Server) setupKafka() error {
	...
	s.consumer, err = kafka.NewKafkaConsumer(brokers, s.cfg.KafkaGroupId, []string{"validate_user_topic"}, s.msg)
	if err != nil {
